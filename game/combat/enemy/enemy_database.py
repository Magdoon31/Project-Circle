...
class EnemyDB:
    def __init__(self, sfx):
        self.enemies = {
            ...
            "slime_small": [0,0,12,18,"enemy",3.4,6,4,0,"mystical","to_player_jump",{}],
            ...
            "shooter": [0,0,40,22,"enemy",3.2,5,10,0,"human","away_player_distance",
                {"basic": {"damage": 12, "cooldown": 2.2, "last_used": 0, "width": 14, "speed": 16, "range": 3200, "effects": {}, "type":["arrow_red"]}}],


            # --- RAINBOW FIELDS ---

            "rainbow_slime": [0,0,80,24,"enemy",3.8,8,12,1,"mystical","to_player_jump",
                {"death_spiral": {"bullets":4,"damage": 18, "width": 13, "speed": 6, "range": 4000, "effects": {}, "type":["normal_yellow","normal_red","normal_green","normal_blue"]}}],

            "flower_spitter": [0,0,140,23,"enemy",1.0,6,10,0,"animal","away_player_normal",
                {"basic": {"damage": 22, "cooldown": 2.2, "last_used": 0, "width": 12, "speed": 8, "range": 3600, "effects": {"slow":[45,0.15],"homing":[0.4]}, "type":["flower_pink"]}}],

            "rainbow_guard": [0,0,140,30,"enemy",2.1,14,14,4,"human","to_player_normal",
            ...
            "candy_shroom": [0,0,280,24,"enemy",0.8,8,20,1,"plant","random_normal",
                {"spiral": {"damage": 6, "cooldown": 1.5, "last_used": 0, "width": 12, "speed": 8, "range": 3500, "bullets": 12, "effects": {"poison":[185,2]}, "type":["spore"], "stop_move":[60,32]}}],
            ...
            "sugar_caster": [0,0,100,25,"enemy",2.3,10,22,2,"mystical","away_player_normal",
                {"throw": {"radius": 70, "recoil":150, "damage": 30, "width":15, "exp_type":"nova_", "cooldown": 0.8, "last_used": 0, "fly_time": 1.8, "effects": {"speed":[60,0.25]},"stop_move":[48,12], "type":["flower_white"]}}],
            ...
            "robo-tesla": [0,0,310,23,"enemy",1.8,10,30,4,"mechanical","random_normal",
                           {"spiral": {"damage": 22, "cooldown": 1.0, "last_used": 0, "width": 5, "speed": 10, "range": 1800, "bullets": 18, "effects": {"weakness":[120,0.2]}, "type":["normal_blue"]}}],

            "robo-bomber": [0,0,310,23,"enemy",1.8,10,30,4,"mechanical","random_normal",
                            {"throw": {"radius": 180, "recoil":250, "damage": 35, "width":15, "exp_type":"", "cooldown": 3.2, "last_used": 0, "fly_time": 0.8, "effects": {"burn":[60,2]}, "type":["grenade_red"]}}],
            ...
            "frozen_orb": [0,0,290,28,"enemy",0.8,12,30,10,"mystical","random_normal",
                {"spiral": {"damage": 22, "cooldown": 2.4, "last_used": 0, "width": 14, "speed": 8, "range": 4000, "bullets": 8, "effects": {"slow":[60,0.55],"homing":[0.34]}, "type":["normal_blue"]},
                 "death_spiral": {"damage": 22, "cooldown": 0, "last_used": 0, "width": 14, "speed": 8, "range": 4000, "bullets": 16, "effects": {"slow":[60,0.55],"homing":[0.34]}, "type":["normal_blue"]}}],
            ...
            "pixie": [0,0,800,24,"enemy",2.5,40,70,4,"mystical","random_jump",
                {"minigun": {"damage": 25,"cooldown": 1.5,"last_used": 0,"width": 18,"speed": 10,"burst_count": 0,"burst_max": 10,"burst_delay": 0.05,"last_shot": 0,"is_bursting": False, "spread": 360, "range": 3000, "effects" : {"confusion":[120,0.75],"slow":[180,0.25]},"type":["normal_yellow"]}}],
            ...
            "inferno_flower": [0,0,900,26,"enemy",0.6,40,85,5,"mystical","random_normal",
                               {"shotgun":{"damage": 25, "cooldown": 2.5, "last_used": 0, "width": 12, "speed": 12, "range": 2100, "recoil": 40, "bullets": 7, "effects": {"burn":[120,3]}, "type":["flower_orange"]},
            ...
            "frost_flower": [0,0,900,26,"enemy",0.6,40,85,5,"mystical","random_normal",
                               {"shotgun":{"damage": 25, "cooldown": 2.5, "last_used": 0, "width": 12, "speed": 12, "range": 2100, "recoil": 40, "bullets": 7, "effects": {"slow":[120,0.33],"weakness":[160,0.5]}, "type":["flower_blue"]},
            ...
            "toxic_flower": [0,0,900,26,"enemy",0.6,40,85,5,"mystical","random_normal",
                               {"shotgun":{"damage": 25, "cooldown": 2.5, "last_used": 0, "width": 12, "speed": 12, "range": 2100, "recoil": 40, "bullets": 7, "effects": {"acid":[120,0.33],"poison":[180,8]}, "type":["flower_green"]},
            ...
            "voidling": [0,0,500,14,"enemy",2.4,70,80,15,"void","to_player_normal",
        ...
        self.bosses = {
            "boss1": [900, 900,8000,40,"boss",4.2,5,200,20,"undead","to_player",{"basic" : {"damage": 3, "cooldown": 2.0, "last_used": 0, "width": 30, "speed": 9, "range": 2000, "effects" : {"homing":[2],"slow":[180,0.1]}, "type":["missile_blue"]}, 
                                                "spiral1" : {"damage": 2, "cooldown": 3.2, "last_used": 0, "width": 24, "speed": 6, "range": 2000, "bullets": 12, "effects" : {"poison" : [600,2]}, "type":["normal_green"]},
                                                "spiral2" : {"damage": 1, "cooldown": 2.8, "last_used": 0, "width": 8, "speed": 7, "range": 2000, "bullets": 36, "effects" : {"glued" : [60,0.5]}, "type":["normal_yellow"]},
    ...
    def provoke_enemies(self, biome, hard_mode, screen):
        ...
        for i in range(3):  
            for j in range(3):
                ...
                spawn_x = min(w-90,max(90, j * (w // 2)))
                spawn_y = min(h-90,max(90, i * (h // 2)))
                
                spawnpoints.append((spawn_x, spawn_y))

        provoked_enemies = []
        # lower end_point of spawn amount should be at least 1 lower than upper end_point (it is chosen at random({lower},{upper}))
        # biome : [[{lower spawn amount},{upper spawn amount}, [enemies]]]
        biomes = {
            "village": [[3,6],["slime_small","slime_big","shooter"]],
            "rainbow_fields": [[1,4],["rainbow_slime","flower_spitter","rainbow_guard"]],
            "sugarwood_grove": [[2,4],["gum_goblin","candy_shroom","toffee_runner","sugar_caster"]],
            "toy_factory": [[3,5],["toy_soldier","portable_factory","robo-tesla","robo-bomber","scrap_beetle"]],
            "silverpine_tundra": [[3,5],["frost_wolf","ice_shooter","frozen_orb"]],
            "underground_garden": [[3,6],["pixie","rainbow_pixie","poison_skeleton","inferno_flower","frost_flower","toxic_flower"]],
            "the_core": [[3,6],["liche","skeleton","guard","fly","generator"]],
            "the_void": [[4,6],["voidling","red_crystal","purple_crystal","blue_crystal"]],
        }
